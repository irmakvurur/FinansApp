...
public final class ActivitySinginBinding implements ViewBinding {
  ...
  private ActivitySinginBinding(@NonNull LinearLayout rootView, @NonNull Button buttonLogin,
  ...
  public static ActivitySinginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_singin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivitySinginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySinginBinding((LinearLayout) rootView, buttonLogin, editTextMail,
