...
public final class ActivityGelirActivtiyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGelirActivtiyBinding(@NonNull RelativeLayout rootView,
      @NonNull TextView accountTitle, @NonNull LinearLayout bankAccount1Layout,
      @NonNull LinearLayout bankAccount1Layout1, @NonNull LinearLayout bankAccount1Layout3,
      @NonNull TextView bankAccountInfo1, @NonNull TextView bankAccountInfo2,
      @NonNull TextView bankAccountInfo3, @NonNull ImageView bankImage1,
      @NonNull ImageView bankImage2, @NonNull ImageView bankImage3, @NonNull TextView bankName1,
      @NonNull TextView bankName2, @NonNull TextView bankName3, @NonNull TextView totalAmountText,
  ...
  @NonNull
  public static ActivityGelirActivtiyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGelirActivtiyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_gelir_activtiy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGelirActivtiyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGelirActivtiyBinding((RelativeLayout) rootView, accountTitle,
          bankAccount1Layout, bankAccount1Layout1, bankAccount1Layout3, bankAccountInfo1,
          bankAccountInfo2, bankAccountInfo3, bankImage1, bankImage2, bankImage3, bankName1,
          bankName2, bankName3, totalAmountText, welcomeText);
    }
